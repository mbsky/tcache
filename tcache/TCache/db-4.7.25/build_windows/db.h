...
#define DB_NOLRU_OUTOFMEM     (-31000)
...
#define	DB_ENV_YIELDCPU		0x00020000 /* DB_YIELDCPU set */
	u_int32_t flags;
	u_int32_t disableLRU;	//[Igor]: flag to diasable LRU
 ...
 */
//[Igor]: New flag for disabling LRU
#define DB_DISABLE_LRU		  0x00020000	// Hopefully it won't collide with other flags.
